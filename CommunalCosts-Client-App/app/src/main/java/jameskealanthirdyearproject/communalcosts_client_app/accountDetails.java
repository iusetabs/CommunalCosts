...
public class accountDetails extends AppCompatActivity {
    ...
    private void displayAccountDetails(DataSnapshot dataSnapshot){
        myAccount.setEmail(dataSnapshot.child(user.getUid()).getValue(Account.class).getEmail());
        email.setText(myAccount.getEmail(), TextView.BufferType.EDITABLE);

        myAccount.setName(dataSnapshot.child(user.getUid()).getValue(Account.class).getName());
